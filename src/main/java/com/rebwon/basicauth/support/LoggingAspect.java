...
public class LoggingAspect {
  @Pointcut("within(com.rebwon.basicauth.web..*) || within(com.rebwon.basicauth.domain..*)")
  ...
  private boolean isUtilMethod(String name) {
    return name.startsWith("get") || name.startsWith("set") || name.startsWith("toString") ||
        name.startsWith("equals") || name.startsWith("hashCode");
  }
}
